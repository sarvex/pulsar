...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'msgRateOut',
                    models.DecimalField(
                        decimal_places=1, default=0, max_digits=12
                    ),
                ),
                (
                    'msgRateRedeliver',
        ...
        migrations.AlterIndexTogether(
            name='topic', index_together={('name', 'cluster', 'timestamp')}
        ),
    ]
